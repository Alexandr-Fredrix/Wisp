"""Validate source-preview metadata without game assemblies."""
import json
import pathlib
import re
...
def metadata():
    ...
    if data["stage"] != "source-preview":
        raise ValueError("This publisher only supports source previews")
    return data
...
if __name__ == "__main__":
    print("Validated Wisp source preview", validate())

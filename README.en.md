...
**0.3.0-alpha.1 · Hollow Knight 1.5.12620 · Windows x64 · BepInEx 5.4.23.5**
...
![Wisp guide](docs/images/route.png)

Install BepInEx 5 x64 once. Extract Wisp-0.3.0-alpha.1.zip into the game directory, then press F8 in a loaded save. Wisp itself is one installed DLL. Images cache on demand. Full regional reference maps currently require a separately prepared cache.

Early build: startup, loaded-save guide and journal tested on Windows at 2560x1440. Physical controller testing and full playthrough pending. Four entries have no habitat map. A guide goal does not change the game's actual save mode.

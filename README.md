> Основной выпуск — **1.0.0**. Для проверки исправлений и оптимизации: [**1.0.1 (предварительный выпуск)**](https://github.com/Alexandr-Fredrix/Wisp/releases/tag/v1.0.1). Игровые проверки 1.0.1 ещё предстоят; [результаты автоматических проверок](docs/releases/1.0.1.md).

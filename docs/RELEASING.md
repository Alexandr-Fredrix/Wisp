...
5. Create a GitHub release, add its notes, ZIP and .sha256 file, then publish. Keep alpha status and unverified behavior explicit. Latest identifies the latest download, not stability.
